...
export const postUserThunk = createAsyncThunk('auth/postUser', postUser);

export const postLogInThunk = createAsyncThunk('auth/postLogIn', postLogIn);

export const postLogOutThunk = createAsyncThunk('auth/postLogOut', postLogOut);
